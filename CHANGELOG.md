...
* Added XML attributes from stubbles/xml-attributes, replaces XML annotations. XML annotations are kept for backward compatibility in the 10.x series, but will be removed with 12.0.0.
